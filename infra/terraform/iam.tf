...
# Policy para ler segredo do InfluxDB
resource "aws_iam_policy" "read_influxdb_secret" {
  name        = "${var.project_name}-ReadInfluxDBSecretPolicy"
  description = "Permite leitura das credenciais do InfluxDB"
